...
class CSaveUespSquidPageCounts
{
	...
	public function SaveData()
	{
		...
		$result = $this->db->query("DROP TABLE IF EXISTS popularPageCountTmp;");
		if ($result === false) return $this->ReportError("Failed to drop the popularPageCountTmp table! {$this->db->error}");
